...
# Where the Visualization tab loads the OntoPortal BioMixer Visualizer from.
# Unset means the copy vendored under public/visualizer; set this to serve a
# separately hosted one instead, e.g. "https://visualizer.example.org".
$VISUALIZER_URL = ENV['VISUALIZER_URL']
