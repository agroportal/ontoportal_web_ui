...
# Piano Analytics site ID and collect domain (optional, both required to enable the tag)
$PIANO_SITE_ID = ENV['PIANO_SITE_ID']
$PIANO_COLLECT_DOMAIN = ENV['PIANO_COLLECT_DOMAIN']
